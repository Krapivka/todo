...
class GoogleDriveService {
  ...
  var signedIn = false;
  static const _folderName = "TaskCalendarBackups";
  ...
  uploadFileToGoogleDrive() async {
    ...
    final fileName = 'task_calendar_backup_$formattedDate.json';
  ...
  Future<void> restoreBackupFromGoogleDrive() async {
    ...
    final query =
        "'$folderId' in parents and mimeType != 'application/vnd.google-apps.folder' and name contains 'task_calendar_backup_'";
